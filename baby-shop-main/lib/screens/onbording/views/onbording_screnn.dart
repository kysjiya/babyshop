...
class _OnBordingScreenState extends State<OnBordingScreen> {
  ...
  final List<Onbord> _onbordData = [
    Onbord(
      ...
      description:
          "Here you’ll see rich varieties of goods for your baby, carefully classified for seamless browsing experience.",
    ),
    Onbord(
      ...
      description:
          "Add any item you want to your cart, or save it on your wishlist, so you don’t miss it in your future purchases for your baby.",
    ),
    Onbord(
    ...
    Onbord(
      ...
      description:
          "In particular, Baby Shop Hub can pack your orders, and help you seamlessly manage your shipments.",
    ),
    Onbord(
