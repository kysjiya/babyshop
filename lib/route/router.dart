...
import 'package:shop/screens/checkout/views/cart_screen3.dart';
...
import 'package:shop/screens/profile/views/profilePage.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case cart2ScreenRoute:
      return MaterialPageRoute(
        builder: (context) =>  Cartscreen2(),
      );
    case cart3ScreenRoute:
      return MaterialPageRoute(
